...
class Users extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['type', 'username', 'email', 'password', 'salt', 'first_name', 'last_name', 'last_login', 'last_activity', 'time_created', 'mobile', 'college', 'location', 'description', 'work', 'professionalskill', 'school', 'othermobile', 'aboutyou', 'nickname', 'favquotes'], 'required'],
            [['type', 'username', 'email', 'password', 'first_name', 'last_name', 'activation'], 'string'],
            [['last_login', 'last_activity', 'time_created'], 'integer'],
            [['salt'], 'string', 'max' => 8],
            [['mobile', 'othermobile'], 'string', 'max' => 20],
